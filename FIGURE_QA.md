...
Archetype: quantitative grid. `final_benchmark` and `mass_jes_profile_scatter` are the hero figures; generator, one-dimensional likelihood, JES, and two-dimensional likelihood panels are diagnostics.
